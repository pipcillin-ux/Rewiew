...
Also locate the project style guide (usually `CLAUDE.md` or `STYLE.md` in the
...
If CLAUDE.md identifies this project as a narrative review, do not write in the
