# AGENTS.md — Narrative Literature Review Workflow Instructions

> Codex reads this file automatically at the start of each session.
> Keep it aligned with `CLAUDE.md` so both agents follow the same workflow.
...
At the beginning of each Codex session:
